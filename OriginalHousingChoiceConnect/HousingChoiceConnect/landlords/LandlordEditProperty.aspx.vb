...
Public Class LandlordEditProperty
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            populateDropdwonList(landlordPropertyID)
        End If
    End Sub
    ...
    Public Sub btnEditProperty(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Response.Redirect("/landlords/ViewProperty.aspx?LandlordPropertyID=" & landlordPropertyID)
    End Sub
