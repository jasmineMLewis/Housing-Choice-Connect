<%@ Page Title="Housing Choice Connect" Language="vb" AutoEventWireup="false" MasterPageFile="~/UserDashboard.Master"
    CodeBehind="LandlordDashboard.aspx.vb" Inherits="HousingChoiceConnect.LandlordDashboard" %>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="panel panel-warning">
                        ...
                        <a href="/landlords/LandlordActiveProperties.aspx?UserID=<% Response.Write(userID) %>" class="text-warning">
                ...
                <div class="col-lg-4">
                    <div class="panel panel-info">
                        ...
                        <a href="/landlords/LandlordInactiveProperties.aspx?UserID=<% Response.Write(userID) %>" class="text-info">
                            <div class="panel-footer">
                ...
                <div class="col-lg-4">
                    <div class="panel panel-danger">
                        ...
                        <a href="/landlords/LandlordSoonDeletedProperties.aspx?UserID=<% Response.Write(userID) %>" class="text-danger">
                            <div class="panel-footer">
