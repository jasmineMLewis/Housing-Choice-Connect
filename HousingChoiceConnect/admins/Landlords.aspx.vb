...
Public Class Landlords
    ...
    Protected Function DisplayDeleteLink(ByVal landlordUserID As Integer, ByVal sessionUserID As Integer) As String
        Return "<a href=/admins/AdminDeleteLandlord.ashx?LandlordUserID=" & landlordUserID & "&UserID=" & sessionUserID & "><i class='fa fa-trash'></i></a>"
    End Function

    Protected Function DisplayEditLink(ByVal landlordUserID As Integer, ByVal sessionUserID As Integer) As String
        Return "<a href=/admins/AdminEditLandlord.aspx?LandlordUserID=" & landlordUserID & "&UserID=" & sessionUserID & "><i class='fa fa-pencil'></i></a>"
    End Function
    ...
    Protected Function DisplayNameLink(ByVal landlordUserID As Integer, ByVal name As String, ByVal sessionUserID As Integer) As String
        Return "<a href=/admins/AdminViewLandlord.aspx?LandlordUserID=" & landlordUserID & "&UserID=" & sessionUserID & ">" & name & "</a>"
    End Function
