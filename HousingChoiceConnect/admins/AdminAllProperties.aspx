<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/UserDashboard.Master"
    CodeBehind="AdminAllProperties.aspx.vb" Inherits="HousingChoiceConnect.AdminAllProperties" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        <i class="fa fa-battery-full fa-fw"></i>&nbsp; All Properties
                    </h1>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="panel-body">
                                    <div class="list-group">
                                        ...
                                        <div class="list-group-item text-center">
                                            <button id="Button1" type="button" class="btn btn-default btn-block btn-lg" runat="server"
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="GridViewProperties" runat="server" CssClass="table" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="DateOfPostage" HeaderText="Posted" SortExpression="DateOfPostage" /> 
                                        <asp:BoundField DataField="DateLastUpdated" HeaderText="Last Updated" SortExpression="DateLastUpdated" /> 
