<%@ Page Title="Housing Choice Connect" Language="vb" AutoEventWireup="false" MasterPageFile="~/UserDashboard.Master"
    CodeBehind="AdminActiveProperties.aspx.vb" Inherits="HousingChoiceConnect.AdminActiveProperties" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        <i class="fa fa-battery-three-quarters fa-fw"></i>&nbsp; Active Properties
                    </h1>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <button id="Button2" type="button" class="btn btn-success btn-block btn-lg" runat="server"
