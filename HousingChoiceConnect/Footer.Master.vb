...
Public Class Footer
    ...
    Protected Sub btnSubmitClick(sender As Object, e As EventArgs)
        ...
        '    msg.Body = "<!DOCTYPE HTML><html><head></head><body><h1>Housing Choice Connect - Contact Us </h1> <br />" +
        '                       "<b>Name: </b> <font color=#336699>" + contactUsModalName.Text + "</font> <br />" +
        '                       "<b>Phone Number: </b> <font color=#336699>" + contactUsModalPhoneNumber.Text + "</font> <br />" +
        '                       "<b>Date of submission:  </b> <font color=#336699>" + Now.ToShortDateString + "</font> <br /><br />" +
