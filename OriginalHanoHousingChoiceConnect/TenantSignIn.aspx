<%@ Page Title="Housing Choice Connect" Language="vb" AutoEventWireup="false" MasterPageFile="~/Footer.Master"
    CodeBehind="TenantSignIn.aspx.vb" Inherits="HanoChoiceConnect.TenantLogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="alert alert-warning text-center" role="alert">
                            Forgot Password? <a href="TenantEmailResetPassword.aspx">Reset Password</a></div>
    ...
    <div id="space" style="margin-top: 185px;">
    </div>
</asp:Content>
