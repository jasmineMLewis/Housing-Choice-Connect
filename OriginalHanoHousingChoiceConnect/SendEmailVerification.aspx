<%@ Page Title="Housing Choice Connect" Language="vb" AutoEventWireup="false" MasterPageFile="~/Footer.Master"
    CodeBehind="SendEmailVerification.aspx.vb" Inherits="HanoChoiceConnect.SendEmailVerification" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <nav class="navbar navbar-default navbar-fixed-top">
    ...
    <section id="landlordEmailVerification" class="text-center">
       <div class="row">
             <div class="col-md-4 col-md-offset-4">
                  <div class="panel panel-default">
                    <div class="panel-heading">
                          <h3 class="panel-title">Send NEW Email Verification Code</h3>
                    </div>
                    <div class="panel-body">
                         <div class="alert alert-warning" role="alert">Enter your email address</div>
                         <div class="picture">
                              <i class="fa fa-envelope big-icon" aria-hidden="true"></i>
                         </div>
                          <div class="form">
                              <div class="input-group input-group-lg inputFormat">
                                  <span class="input-group-addon" id="Span1"><span class="glyphicon glyphicon-envelope"></span></span>
                                 <asp:TextBox ID="email" runat="server" class="form-control" placeholder="Email Address" name="email" aria-describedby="sizing-addon5" maxlength="100"></asp:TextBox>
                              </div>
                              <br />
                              <button id="btnEmailVerificationCode" type="button" class="btn btn-info btn-block btn-lg" runat="server" onserverclick="btnEmailNewVerificationCode">
                                    <i class="fa fa-envelope"></i> &nbsp; Send NEW Verification Code
                              </button>
                              <p>
