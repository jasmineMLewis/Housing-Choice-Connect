<%@ Page Title="Housing Choice Connect" Language="vb" AutoEventWireup="false" MasterPageFile="~/UserDashboard.Master"
    CodeBehind="LandlordAddProperty.aspx.vb" Inherits="HanoChoiceConnect.LandlordAddProperty" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        <i class="fa fa-plus fa-fw"></i>Add Property</h1>
                </div>
            </div>
                                ...
                                <div class="panel panel-success">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="input-group input-group-lg inputFormat">
                                            ...
                                            <asp:SqlDataSource ID="SqlNeighborhood" runat="server" ConnectionString="<%$ ConnectionStrings:HanoChoiceConnectConnectionString %>"
                                    ...
                                    <div class="panel-body table-responsive">
                                        <div class="form-inline text-center">
                                            <div class="input-group input-group-lg inputFormat col-sm-4">
                                                ...
                                                <input type="text" class="form-control" id="rent" name="rent" placeholder="Rent * (i.e. 1000)"
                                                    maxlength="4" required="requried" />
                                                <span class="input-group-addon">.00</span>
                                            </div>
                                            <div class="input-group input-group-lg inputFormat col-sm-4">
                                                <span class="input-group-addon">$</span>
                                                <input type="text" class="form-control" id="deposit" name="deposit" placeholder="Deposit * (i.e. 1000)"
                                                    maxlength="4" required="requried" />
                                                <span class="input-group-addon">.00</span>
                                            </div>
                                            <div class="input-group input-group-lg inputFormat col-sm-3">
                                             ...
                                             <input type="text" id="dateAvailableToRent" name="dateAvailableToRent" class="form-control"
                                                    placeholder="Date Available * (12/02/2017)" maxlength="10" required="requried" />
                                            </div>
                                        </div>
                                        <div class="form-inline text-center">
                                            <div class="input-group input-group-lg inputFormat col-sm-3">
                                            ...
                                            <div class="input-group input-group-lg inputFormat col-sm-2">
                                                <span class="input-group-addon"><span class="glyphicon glyphicon-bitcoin">
                                                </span></span>
                                            ...
                                            <div class="input-group input-group-lg inputFormat col-sm-2">
                                                ...
                                                <asp:SqlDataSource ID="SqlPropertyType" runat="server" ConnectionString="<%$ ConnectionStrings:HanoChoiceConnectConnectionString %>"
                                            ...
                                            <div class="input-group input-group-lg inputFormat col-sm-3">
                                                ...
                                                <asp:SqlDataSource ID="SqlUnitType" runat="server" ConnectionString="<%$ ConnectionStrings:HanoChoiceConnectConnectionString %>"
                                        ...
                                        <br />
                                           <div class="form-group">
                                                <textarea class="form-control" placeholder="Property Description (Opttional)" cols="5" rows="5" name="description" id="description" maxlength="140"></textarea>
                                            </div>
                                ...
                                <div class="panel panel-success">
                                    ...
                                    <div class="panel-body table-responsive">
                                        <div class="input-group input-group-lg inputFormat">
                                            ...
                                            <input type="text" name="contactName" class="form-control" placeholder="Person of Contact Name * (i.e. Sam Winchester)"
                                                aria-describedby="sizing-addon7" maxlength="25" required="required" />
                                        </div>
                                        <div class="input-group input-group-lg inputFormat">
                        ...
                        <div class="panel-heading text-center">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseAddProperty"><i
                                    class="fa fa-plus" aria-hidden="true"></i>&nbsp;Submit NEW Property</a>
                            </h4>
                        </div>
                        <div id="collapseAddProperty" class="panel-collapse collapse">
                            <div class="panel-body">
                                <div class="panel panel-success">
                                    <div class="panel-heading text-center">
                                        <h3 class="panel-title">
                                            <i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Submit NEW Property</h3>
                                    </div>
                                    <div class="panel-body table-responsive">
