<%@ Page Title="Housing Choice Connect" Language="vb" AutoEventWireup="false" MasterPageFile="~/Footer.Master"
    CodeBehind="Default.aspx.vb" Inherits="HanoChoiceConnect._default" %>
                ...
                <li>
                 <div class="dropdownBtn">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li>
                            <a href="LandlordSignIn.aspx"><i class="fa fa-home">&nbsp; <b>Landlord</b></i> <span class="tab-space-landlord"></span>
                            <span class="glyphicon glyphicon-chevron-right"></span></a>
                        </li>
                        <li>
                            <a href="AdminSignIn.aspx"><i class="fa fa-lock">&nbsp; <b>Admin</b></i> <span class="tab-space-admin"></span>
                            <span class="glyphicon glyphicon-chevron-right"></span></a>
                        </li>
                    </ul>      
                 </div>
