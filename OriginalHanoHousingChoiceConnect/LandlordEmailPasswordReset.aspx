<%@ Page Title="Housing Choice Connect" Language="vb" AutoEventWireup="false" MasterPageFile="~/Footer.Master"
    CodeBehind="LandlordEmailPasswordReset.aspx.vb" Inherits="HanoChoiceConnect.LandlordEmailPasswordReset" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <div class="form">
                            <div class="input-group input-group-lg">
                                ...
                                <asp:TextBox ID="email" runat="server" class="form-control" placeholder="Email Address"
                                    name="email" aria-describedby="sizing-addon5" MaxLength="100"></asp:TextBox>
                            </div>
                            <br />
                            <button type="button" class="btn btn-info btn-block btn-lg" id="btnGetRandomSecurityQuestions"
                                runat="server" onserverclick="btnSubmitClick">
                                <i class="fa fa-random"></i>Get Random Security Questions
                            </button>
    ...
    <div id="space" style="margin-top: 220px;">
    </div>
</asp:Content>
