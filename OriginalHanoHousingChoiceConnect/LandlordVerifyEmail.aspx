<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Footer.Master" CodeBehind="LandlordVerifyEmail.aspx.vb" Inherits="HanoChoiceConnect.LandlordVerifyEmail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <nav class="navbar navbar-default navbar-fixed-top">
    ...
    <div id="landlordEmailVerification">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="panel panel-default">
                    <div class="panel-heading text-center">
                        <h3 class="panel-title">
                         Landlord Email Verification</h3>
                    </div>
                        ...
                        <div class="form">
                            ...
                            <div class="form">
                                <div class="input-group input-group-lg">
                                    <span class="input-group-addon" id="Span1"><span class="glyphicon glyphicon-envelope"></span>
                                    </span>
                                    <asp:TextBox ID="emailAdrdressToVerify" runat="server" class="form-control" placeholder="Email Adrdress to Verify"
                                        name="emailAdrdressToVerify"  ></asp:TextBox>
                                </div>
                                <asp:HiddenField ID="hdCode" runat="server"></asp:HiddenField>
                                <br />
                                <button type="button" class="btn btn-info btn-block btn-lg" runat="server" onserverclick="btnEmailAdrdressToVerify">
                                    <i class="fa fa-envelope"></i> &nbsp; Email Adrdress to Verify
                                </button>
                            </div>
                        </div>
                    </div>
 ...
 <div id="space" style="margin-top: 190px;"></div>
</asp:Content>
