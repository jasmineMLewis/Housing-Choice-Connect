<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/UserDashboard.Master"
    CodeBehind="AdminAddProperty.aspx.vb" Inherits="HanoChoiceConnect.AdminAddProperty" %>
                                        ...
                                        <div class="list-group">
                                            <div class="list-group-item">
                                                <div class="input-group input-group-lg">
                                                    ...
                                                    <asp:SqlDataSource ID="SqlFullDescrp" runat="server" ConnectionString="<%$ ConnectionStrings:HanoChoiceConnectConnectionString %>"
                                                        SelectCommand="SELECT [UserID], [FirstName] + ' ' + [LastName]  + ' :: ' + [Email] As FullDescrp FROM [Users] WHERE [fk_RoleID] = '5' ORDER BY [FullDescrp] ASC">
                                                    </asp:SqlDataSource>
                                                </div>
                                            </div>
                                        </div>
