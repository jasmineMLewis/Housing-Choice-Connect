<%@ Page Title="Housing Choice Connect" Language="vb" AutoEventWireup="false" MasterPageFile="~/Footer.Master"
    CodeBehind="LandlordSignIn.aspx.vb" Inherits="HanoChoiceConnect.LandlordSignIn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="alert alert-warning text-center" role="alert">
                            Forgot Password? <a href="LandlordEmailPasswordReset.aspx">Reset Password</a></div>
                        <div class="text-center">
                            <i class="fa fa-home big-icon" aria-hidden="true"></i>
                        </div>
                        <div class="form">
                            ...
                            <button type="button" class="btn btn-info btn-block btn-lg" id="btnLandlordSignIn"
    ...
    <div id="space" style="margin-top: 183px;">
    </div>
</asp:Content>
